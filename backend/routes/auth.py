...
from backend.models.student import Student, Role
from backend.models.faculty import Faculty, FacultyRole
from backend.auth.hashing import hash_password, verify_password
from backend.auth.jwt_handler import create_access_token
from backend.services.student_service import get_student_by_email
from backend.services.faculty_service import get_faculty_by_email
