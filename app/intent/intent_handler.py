from app.intent.intent_detector import detect_intent, _extract_branch
from app.session.session import get as get_session, update as update_session, clear_pending

from app.handlers.greeting_handler    import handle_greeting, handle_thanks, handle_farewell
from app.handlers.fees_handler         import handle_fees
from app.handlers.documents_handler    import handle_documents
from app.handlers.admission_handler    import (
...
from app.handlers.rag_handler          import handle_rag
from app.handlers.general_chat_handler import handle_general_chat
from app.handlers.emergency_handler    import handle_emergency, handle_alert
